...
SRC_URI:lab4-qemuarm64 = "git://${HOME}/yp-summit-nov-21/linux-stable-work.git;protocol=file;name=machine;branch=${KBRANCH}"
...
LINUX_VERSION:lab4-qemuarm64 ?= "5.15.2"
LINUX_VERSION_EXTENSION:lab4-qemuarm64 ?= "-custom"

SRCREV_machine:lab4-qemuarm64 = "${AUTOREV}"
SRCREV_meta:lab4-qemuarm64 = "bee5d6a15909f05935f4a61f83a72cddfca7934a"
